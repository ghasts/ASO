...
$sql = "select goods.dispflag,goods.goodscode,goods.goods,goods.kind,goods.price from goods where kind = '$Fkind' ";
...
$sql = "select goods.dispflag,goods.goodscode,goods.goods,goods.kind,goods.price from goods where kind = '$Fkind' and goods like ? ";
   ...
   <div id="headWrap">
      <div id="header">
         ...
         <div id="gnavi">
			...
			<input type="submit"  alt="検索" name="searchBtn1" id="searchBtn1" value="" style="background:url(serch.gif);width:32px;height:32px;border:0px solid;" />
