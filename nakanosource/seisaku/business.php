...
$sql = 'select goods.dispflag,goods.goods,goods.kind,goods.size,stock.stock,stock.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ビジネスシューズ\' ';
...
$sql = 'select goods.dispflag,goods.goods,goods.kind,goods.size,stock.stock,stock.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ビジネスシューズ\' and goods like ? ';
