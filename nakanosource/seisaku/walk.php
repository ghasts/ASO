...
$sql = 'select goods.dispflag,goods.goods,goods.kind,goods.size,stock.stock,stock.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ウォーキング\' ';
...
$sql = 'select goods.dispflag,goods.goods,goods.kind,goods.size,stock.stock,stock.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ウォーキング\' and goods like ? ';
