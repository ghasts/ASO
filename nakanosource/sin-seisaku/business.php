...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ビジネスシューズ\' ';
...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ビジネスシューズ\' and goods like ? ';
...
<div id="top">
  ...
  <?php if($acflag != 0){ print($accname."様");}else{print("ログインされていません。");?>
            ...
            <form name="searchform1" id="searchform1" method="get" action="business.php">
