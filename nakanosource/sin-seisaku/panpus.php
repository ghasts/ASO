...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'パンプス\' ';
...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'パンプス\' and goods like ? ';
