...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'サンダル\' ';
...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'サンダル\' and goods like ? ';
   ...
   <div id="headWrap">
      <div id="header">
         ...
         <div id="gnavi">
            ...
            <form name="searchform1" id="searchform1" method="get" action="sandals.php">
