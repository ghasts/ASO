...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ウォーキング\' ';
...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'ウォーキング\' and goods like ? ';
   ...
   <div id="headWrap">
      <div id="header">
         ...
         <div id="gnavi">
            ...
            <form name="searchform1" id="searchform1" method="get" action="walk.php">
