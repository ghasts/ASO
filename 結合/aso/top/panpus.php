...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price,images from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'パンプス\' ';
...
$sql = 'select goods.dispflag,goods.goodscode,goods.goods,goods.kind,stock.stock,goods.price,images from goods left outer join stock on  goods.stockcode = stock.stockcode where kind = \'パンプス\' and goods like ? ';
   ...
   <div id="headWrap">
      <div id="header">
         ...
         <div id="gnavi">
            ...
            <form name="searchform1" id="searchform1" method="get" action="panpus.php">
...
<li>  
<dl>  
<dt><a href="#"><img src=<?php print($images); ?> alt="" width="100" height="100" /></a></dt>  
